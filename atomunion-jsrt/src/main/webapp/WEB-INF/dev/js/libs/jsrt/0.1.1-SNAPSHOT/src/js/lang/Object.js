/*
 * ! JSRT JavaScript Library 0.2.2 lico.atom@gmail.com
 *
...
(function() {
    var $class = Class.forName({
        ...
        "non-enumerable non-writable non-configurable getClass" : function() {
            return this.$class || Object.$class;
        },
        /** 指示某个其他对象是否与此对象“相等”。 */
        "writable non-configurable equals" : function(obj) {
            return obj === this;
        },
        "non-writable non-configurable getVersion" : (function() {
            /** 主版本号 . 子版本号 [ 修正版本号 [. 编译版本号 ]] */
            var version = "0.2.2-SNAPSHORT";
            return function() {
                return this.version || version;
            };
        })(),
        "writable non-configurable hashCode" : function() {
