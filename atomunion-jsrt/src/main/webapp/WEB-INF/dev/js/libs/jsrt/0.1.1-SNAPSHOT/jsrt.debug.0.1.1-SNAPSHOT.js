...
(function() {
    ...
    if (USEECMA) {
        Object.defineProperties(Object,  {"extend":{value : extend,
            writable : false,
            enumerable : false,
            configurable : false},
            
            "USEECMA":{value : USEECMA,
            writable : false,
            enumerable : false,
            configurable : false}
    ...
    var $class = function(classDef, classloader) {
        ...
        var name = fetch(fullName, function(name, value) {
            value[name] = classConstructor;
             ...
             if (Object.USEECMA) {
                 Object.defineProperty(value[name],  "$class",{value : this,
                        writable : false,
                        enumerable : false,
                        configurable : false});
             }else{
                ...
                if (superClass === Object.$class) {
                    ...
                    if (Object.USEECMA) {
                        ...
                        Object.defineProperty(classConstructor.prototype, "toString", {
                            ...
                            configurable : (m.getModifiers() & 2048) != 0
                        });
                    } else {
...
(function() {
    var $class = Class.forName({
        ...
        "writable configurable toString" : function() {
