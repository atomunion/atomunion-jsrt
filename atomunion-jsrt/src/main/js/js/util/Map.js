...
Class.forName({
	...
	containsKey : function(key) {
		...
		while (e.hasNext()) {
			...
			if (key == k) {
				return true;
			} else if (!Object.isEmpty(key) && !Object.isEmpty(key.equals)
	...
	containsValue : function(value) {
		...
		while (e.hasNext()) {
			...
			if (value == v) {
				return true;
			} else if (!Object.isEmpty(value) && !Object.isEmpty(value.equals)
					&& Object.isFunction(value.equals) && value.equals(v)) {
				return true;
			}
		}
		return false;
		...
		while (correctEntry == null && i.hasNext()) {
			...
			if (key == e.getKey()) {
				correctEntry = e;
					...
					&& Object.isFunction(key.equals) && key.equals(e.getKey())) {
				correctEntry = e;
			}
		}
		var oldValue = null;
